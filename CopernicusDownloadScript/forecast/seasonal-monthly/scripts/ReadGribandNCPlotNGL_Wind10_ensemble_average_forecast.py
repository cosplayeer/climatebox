...
rlist = Ngl.Resources()
wks_type = "png"
wks = Ngl.open_wks(wks_type,"pic/Wind10_ensemble_average_forecast",rlist)
...
for i in range(0,nplots):
  ...
  plot.append(Ngl.contour(wks,Ngl.add_cyclic(Wind10_ensemble_average[i,:,:]),resources))
...
for i in range(0,nplots):
  ...
  plot.append(Ngl.contour_map(wks,Ngl.add_cyclic(Wind10_ensemble_average[i,:,:]),resources))
