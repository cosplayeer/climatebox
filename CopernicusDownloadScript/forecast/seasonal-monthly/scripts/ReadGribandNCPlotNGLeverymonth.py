...
f3 = Nio.open_file(fname3, mode='r',\
    options = None, format='nc')
Wind10_avg_03 = f3.variables['Speed']

f4 = Nio.open_file(fname4, mode='r',\
    options = None, format='nc')
Wind10_avg_04 = f4.variables['Speed']

f5 = Nio.open_file(fname5, mode='r',\
    options = None, format='nc')
Wind10_avg_05 = f5.variables['Speed']

f6 = Nio.open_file(fname6, mode='r',\
    options = None, format='nc')
Wind10_avg_06 = f6.variables['Speed']

f7 = Nio.open_file(fname7, mode='r',\
    options = None, format='nc')
Wind10_avg_07 = f7.variables['Speed']

f8 = Nio.open_file(fname8, mode='r',\
    options = None, format='nc')
Wind10_avg_08 = f8.variables['Speed']



Wind10_ensemble_average = np.average(Wind10_forecast, axis=0)
...
wks = Ngl.open_wks(wks_type,"pic/Wind10_ensemble_forecast_minus_averagemonth3-8_percent",rlist)
