...
def lasso_model(f1, f2, ilat, jlon, imonth=1):
    ...
    for i in range(21):
        ...
        spd10mObsArrayPandas = spd10mObsArray[16:20]  # 18:21
    ...
    spd10mFor = f2.variables["speed10"][16:20, :15, ilat, jlon]  # 18:21
...
if __name__ == '__main__':
    varSpeed = circle2021(imonth=4)
    # varSpeed = test_varSpeed2()
    outputnc(varSpeed, imonth=4, year=2021)
