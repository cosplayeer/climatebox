...
; and then get average of all months.
    ...
    sptemp@long_name = "10 m wind speed deviation(m/s) of 2017 minus 38 years average "
...
; average begin
    ...
    wks = gsn_open_wks("png", outputdir+ "ECMWF_vector10m_deviationyearly_map")
; color choose
;    gsn_define_colormap(wks,"gui_default")
    gsn_define_colormap(wks,"wind_17lev")
