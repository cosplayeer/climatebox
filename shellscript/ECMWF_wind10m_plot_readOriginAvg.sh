...
; and then get average of all months.
    ...
    sptemp@long_name = "10 m wind speed average of 38 years "
...
; average begin
    ...
    wks = gsn_open_wks("png", outputdir+ "ECMWF_vector10m_Average2yearly_map")
; color choose
;    gsn_define_colormap(wks,"gui_default")
    gsn_define_colormap(wks,"wind_17lev")
...
;---Create the two individual plots
  contour_fill_plot = gsn_csm_contour_map(wks,spdtemp_average,cnres)
